...
<div style="position:absolute;right:0px;top:0px;width:20px;text-align:center;">
  <?php if($this->showOptOut): ?>
    <a class="optOut" href="<?php echo $this->link_optOut ?>" onclick="window.open(this.href); return false;" title="Optout: Eigene Besuche auf der Webseite nicht mehr erfassen"><img src="<?php echo $this->optOutIcon ?>" style="margin-bottom:5px" /></a>
  <?php endif; ?>
  <?php if($this->update && $this->showUpdate): ?>
    <a class="update" href="<?php echo $this->link_server ?>" onclick="window.open(this.href); return false;" title="Ein Update der Piwik-Software auf Version <?php echo $this->update ?> ist verfügbar."><img src="<?php echo $this->updateIcon ?>" style="margin-bottom:10px;" /></a>
  <?php endif; ?>
